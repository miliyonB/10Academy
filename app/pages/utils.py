...
def process_data(df):
    ...
    # Keeping entries where all z-scores are less than 3
...
def visual_data(df):
    ...
    plt.figure(figsize=(10, 8))
    sns.heatmap(wind_correlation_matrix, annot=True,
    ...
    plt.figure(figsize=(10, 8))
    sns.heatmap(temperature_correlation_matrix,
    ...
    df[['GHI', 'DNI', 'DHI', 'WS', 'Tamb', 'TModA', 'TModB']].hist(
        bins=20, figsize=(12, 8), color='skyblue', edgecolor='black', alpha=0.7)
    plt.tight_layout()
    plt.show()
